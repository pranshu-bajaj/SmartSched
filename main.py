...
while cycles <= n:
    ...
    cnt = sum(vehicle_count) # total vehicles
    vehicles = cnt
    total_vehicles += vehicles
    print("Total Vehicles:",cnt)
    t = 0 # time
    print("Initial time:",t,"\n")
    cur_1,cur_2 = max_comb(vehicle_count,wait) # starting lanes
    # assuming 1 sec for 1 vehicle
    i = 0
    while cnt > 0:
        print("Current Lanes:",cur_1+1,cur_2+1)
    ...
    cycles += 1
    total_time += t
    print("Time taken for",vehicles,"vehicles:",t,"\n")
